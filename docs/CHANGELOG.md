...
### Changed
- System blacklist entries are now completely excluded from directory scans and never appear in the UI tree.
- Updated app and build metadata to version 1.0.
